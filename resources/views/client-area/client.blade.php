...
@section('title', $client->name.' - Area privata')

@section('hero')
    <section class="hero-section">
        <div class="hero-content-wrapper fullheight-60 fit-wrapper center-items just-cont-end"
            style="background-image: linear-gradient(rgba(0, 0, 0, 0.25), rgba(0, 0, 0, 0.35)), url('{{ $client->coverImageUrl() }}');">
            <div class="marquee">
...
@section('content')
    <section class="section-standard bottom-line">
        <div class="wrapper grid-2">
            <div class="stack-large text-container">
                <p class="pill">GALLERIA PRIVATA</p>
                <h1>{{ $client->name }}</h1>
            </div>
            <div class="center-vertical">
                <div class="stack-mid">
                    ...
                    @endif
                    <a class="btn-2" href="{{ route('client-area.index') }}">Torna alla tua area</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="section-xl-padding">
        <div class="wrapper lightbox-gallery adaptive-gallery" data-progressive-gallery
            data-gallery-endpoint="{{ route('client-area.clients.gallery', $client) }}"
